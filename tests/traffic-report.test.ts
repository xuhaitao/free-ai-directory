...
test("流量报告输出去重后的互动漏斗",async()=>{
  ...
  try{
    ...
    assert.match(stdout,/1 top3-copy-models/);
    assert.match(stdout,/1 top3-copy-money/);
    assert.match(stdout,/1 top3-copy-stocks/);
    assert.match(stdout,/1 top3-copy-skills/);
    assert.match(stdout,/1 top3-share-models/);
    assert.match(stdout,/1 top3-open-models/);
